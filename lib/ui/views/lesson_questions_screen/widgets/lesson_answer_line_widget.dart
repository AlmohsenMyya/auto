...
class AnswerLessonLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<LessonsQuestionsController>();
    ...
    return InkWell(
      ...
      child: GetBuilder<LessonsQuestionsController>(
        builder: (controller) {
          return Container(
  ...
  Color _getBackgroundColor(LessonsQuestionsController controller) {
    if (showResults) {
