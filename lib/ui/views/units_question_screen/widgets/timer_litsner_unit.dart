...
class UnitTimerListener extends StatefulWidget {
  const UnitTimerListener({Key? key, required void Function() onTimeEnd})
      : super(key: key);

  @override
  _UnitTimerListenerState createState() => _UnitTimerListenerState();
}

class _UnitTimerListenerState extends State<UnitTimerListener> {
  ...
  void initState() {
    super.initState();
    controller = Get.find<UnitsQuestionsController>();
    _startTimer();
  }
