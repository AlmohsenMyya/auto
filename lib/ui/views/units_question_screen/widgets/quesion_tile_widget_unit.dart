...
import 'package:auto/ui/views/units_question_screen/widgets/title_of_questions_unit.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:share_plus/share_plus.dart';
import 'package:showcaseview/showcaseview.dart';

import 'answer_line_widget_unit.dart';

class UnitsQuestionTileWidget extends StatefulWidget {
  final int questionIndex;
  final bool showResults;

  const UnitsQuestionTileWidget({
    Key? key,
  ...
  @override
  State<UnitsQuestionTileWidget> createState() => _UnitsQuestionTileWidgetState();
}

class _UnitsQuestionTileWidgetState extends State<UnitsQuestionTileWidget> {
