...
import 'package:auto2/ui/views/banks_according_to_unit_and_lessons_screen/widgets/banks_according_to_unit_and_lessons_screen_card_widget.dart';
...
class BankAccordingToUnitAndLessonsScreen extends StatefulWidget {
  Subject subject;
  Branch branch;
  BankAccordingToUnitAndLessonsScreen({super.key,required this.branch, required this.subject});
