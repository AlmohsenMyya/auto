...
class _TitleOfQuestionsState extends State<TitleOfQuestions> {
  ...
  Widget build(BuildContext context) {
    final questionPreview = controller.questions[widget.question_index].text
        .length > 200
      ...
      children: [
        PopupMenuButton(
          ...
          <PopupMenuEntry>[
            PopupMenuItem(
              child: Text(
                  'ابلاغ', style: TextStyle(color: context.exPrimaryContainer)),
              value: 'report',
            ),
          ],
          onSelected: (value) {
                  ...
                  return AlertDialog(
                    ...
                    content: TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: context
                              .exPrimaryContainer)
                      ),
                    ),
                    actions: [
        ...
        Expanded(
          child: Column(
            children: [
              RichText(
                text: TextSpan(
                  text: isExpanded ? controller.questions[widget.question_index]
                  ...
                  children: [
                    TextButton(
                      ...
                      child: Text(isExpanded ? 'عرض أقل' : 'عرض المزيد',
                        style: TextStyle(
                          fontSize: 15, color: context.exOnBackground,),),
                    ),
                  ],
                ),
            ],
