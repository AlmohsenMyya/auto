...
class _CoursesQuestionsViewState extends State<CoursesQuestionsView> {
  ...
  late CountdownTimerController _timeController=CountdownTimerController(endTime: endTime);
  ...
  Widget build(BuildContext context) {
   ...
   // ValueListenableBuilder(valueListenable: expansionTile, builder:(context, value, child) =>        ,),
          ...
          Row(children: [
            ...
            Text(open?'إخفاء الأجوبة':'إظهار الأجوبة',style: context.exTextTheme.subtitle1!.copyWith(color: context.exPrimaryColor),)
          ...
          Expanded(
            ...
            itemBuilder: (context, index) {
              return QuestionTileWidget(open: open,);
              },
            itemCount: 21,
          ))
        ],
