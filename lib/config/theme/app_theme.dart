...
class AppTheme {
  ...
  static ThemeData get light {
    final textTheme = appTextTheme(
        _builtInLightTheme.textTheme, _lightColorScheme.primary);

    return _builtInLightTheme.copyWith(

      // primaryColorLight: Colors.blue  ,
sliderTheme: SliderThemeData(activeTickMarkColor: Colors.teal,activeTrackColor: Colors.teal,

valueIndicatorColor: Colors.teal,
disabledActiveTickMarkColor:  Colors.teal
,disabledActiveTrackColor:  Colors.teal,
  disabledInactiveTickMarkColor:  Colors.teal,disabledInactiveTrackColor:  Colors.teal,
  ...
  static ThemeData get dark {
    final textTheme = appTextTheme(
        _builtInLightTheme.textTheme, _darkColorScheme.primary);
